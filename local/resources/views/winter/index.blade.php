            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-11">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index"> <img src="/Wshop/local/public/winter/img/logo.png" alt="logo"> </a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="blog" id="navbarDropdown_1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Shop
                                    </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="blog" id="navbarDropdown_3" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        pages
                                    </a>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature_post_text">
                        <img src="/Wshop/local/public/winter/img/feature_1.png" alt="#">
                        <div class="hover_text">
                            <a href="single-product" class="btn_2">shop for male</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature_post_text">
                        <img src="/Wshop/local/public/winter/img/feature_2.png" alt="#">
                        <div class="hover_text">
                            <a href="single-product" class="btn_2">shop for male</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature_post_text">
                        <img src="/Wshop/local/public/winter/img/feature_3.png" alt="#">
                        <div class="hover_text">
                            <a href="single-product" class="btn_2">shop for male</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="new_arrival_iner filter-container">
                        <div class="single_arrivel_item weidth_1 mix shoes">
                            <img src="/Wshop/local/public/winter/img/arrivel/arrivel_5.png" alt="#">
                            <div class="hover_text">
                                <p>Canvas</p>
                        ...
                        <div class="single_arrivel_item weidth_2 mix women">
                            <img src="/Wshop/local/public/winter/img/arrivel/arrivel_2.png" alt="#">
                            <div class="hover_text">
                                <p>Canvas</p>
                                <a href="single-product">
                                    <h3>Lorem Canvas Low-Top Sneaker</h3>
                        ...
                        <div class="single_arrivel_item weidth_3 mix shoes women">
                            <img src="/Wshop/local/public/winter/img/arrivel/arrivel_3.png" alt="#">
                            <div class="hover_text">
                                <p>Canvas</p>
                                <a href="single-product">
                                    <h3>Lorem Canvas Low-Top Sneaker</h3>
                        ...
                        <div class="single_arrivel_item weidth_3 mix women men">
                            <img src="/Wshop/local/public/winter/img/arrivel/arrivel_4.png" alt="#">
                            <div class="hover_text">
                                <p>Canvas</p>
                                <a href="single-product">
                                    <h3>Lorem Canvas Low-Top Sneaker</h3>
                        ...
                        <div class="single_arrivel_item weidth_2 mix men women">
                            <img src="/Wshop/local/public/winter/img/arrivel/arrivel_1.png" alt="#">
                            <div class="hover_text">
                                <p>Canvas</p>
                                <a href="single-product">
                                    <h3>Lorem Canvas Low-Top Sneaker</h3>
                        ...
                        <div class="single_arrivel_item weidth_1 mix shoes men">
                            <img src="/Wshop/local/public/winter/img/arrivel/arrivel_6.png" alt="#">
                            <div class="hover_text">
                                <p>Canvas</p>
                                <a href="single-product">
                                    <h3>Lorem Canvas Low-Top Sneaker</h3>
