@extends('winter.master') @section('title',"Detail") @section('Content')
...
<head>
    ...
    <link rel="stylesheet" href="/Wshop/local/public/winter/css/lightslider.min.css">
    <!-- font awesome CSS -->
...
<body class="bg-white">
            ...
            <div class="row s_product_inner">
                <div class="col-lg-5">
                    <div class="product_slider_img">
                        <div id="vertical">
                            <div data-thumb="{{ $sps->Img }}">
                                <img src="{{ $sps->Img }}" />
                            </div>
                            {{--
                            <div data-thumb="/Wshop/local/public/winter/img/product_details/prodect_details_2.png">
                                <img src="/Wshop/local/public/winter/img/product_details/prodect_details_2.png" />
                            </div>
                            <div data-thumb="/Wshop/local/public/winter/img/product_details/prodect_details_3.png">
                                <img src="/Wshop/local/public/winter/img/product_details/prodect_details_3.png" />
                            </div>
                            <div data-thumb="/Wshop/local/public/winter/img/product_details/prodect_details_4.png">
                                <img src="/Wshop/local/public/winter/img/product_details/prodect_details_4.png" />
                            </div> --}}
                        </div>
                    </div>
                </div>
                    ...
                    <div class="s_product_text">
                        ...
                        <div class="card_area">
                            ...
                            <div class="add_to_cart">
                                ...
                                <button type="button" onclick="Addcart({{$sps->ID}})" class="btn_3">add to cart</button>
    ...
    <script>
        function Addcart($ID) {
            myObj = {
                IDP: $ID,
                Count: $('.input-number').attr('value'),
            }
            $.ajax({
                type: "get",
                url: "/wshop2/cart/addcart",
                data: {
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <p>
                        ...
                        he left the sea in 1956, they bought a pub for a year before John took a job in Southern Rhodesia with a motor company. Beryl bought their young son a box of watercolours, and when showing him how to use it, she decided that she
                        herself quite enjoyed painting. John subsequently bought her a child’s painting set for her birthday and it was with this that she produced her first significant work, a half-length portrait of a dark-skinned lady with a vacant
                        ...
                        <div class="col-lg-6">
                            <div class="comment_list">
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="/Wshop/local/public/winter/img/product/single-product/review-1.png" alt="" />
                                        </div>
                                ...
                                <div class="review_item reply">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="/Wshop/local/public/winter/img/product/single-product/review-2.png" alt="" />
                                        </div>
                                        <div class="media-body">
                                            <h4>Blake Ruiz</h4>
                                            <h5>12th Feb, 2017 at 05:56 pm</h5>
                                ...
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="/Wshop/local/public/winter/img/product/single-product/review-3.png" alt="" />
                                        </div>
                                        <div class="media-body">
                                            <h4>Blake Ruiz</h4>
                                            <h5>12th Feb, 2017 at 05:56 pm</h5>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_category_product">
                        <div class="single_category_img">
                            <img src="/Wshop/local/public/winter/img/category/category_2.png" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_category_product">
                        <div class="single_category_img">
                            <img src="/Wshop/local/public/winter/img/category/category_3.png" alt="">
                            <div class="category_social_icon">
                                <ul>
                                    <li><a href="#"><i class="ti-heart"></i></a></li>
                                    <li><a href="#"><i class="ti-bag"></i></a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_category_product">
                        <div class="single_category_img">
                            <img src="/Wshop/local/public/winter/img/category/category_4.png" alt="">
                            <div class="category_social_icon">
                                <ul>
                                    <li><a href="#"><i class="ti-heart"></i></a></li>
                                    <li><a href="#"><i class="ti-bag"></i></a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_category_product">
                        <div class="single_category_img">
                            <img src="/Wshop/local/public/winter/img/category/category_5.png" alt="">
                            <div class="category_social_icon">
                                <ul>
                                    <li><a href="#"><i class="ti-heart"></i></a></li>
                                    <li><a href="#"><i class="ti-bag"></i></a></li>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_shopping_details">
                        <img src="/Wshop/local/public/winter/img/icon/icon_1.png" alt="">
                        <h4>Free shipping</h4>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_shopping_details">
                        <img src="/Wshop/local/public/winter/img/icon/icon_2.png" alt="">
                        <h4>Free shipping</h4>
                        <p>Divided face for bearing the divide unto seed winged divided light Forth.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_shopping_details">
                        <img src="/Wshop/local/public/winter/img/icon/icon_3.png" alt="">
                        <h4>Free shipping</h4>
                        <p>Divided face for bearing the divide unto seed winged divided light Forth.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_shopping_details">
                        <img src="/Wshop/local/public/winter/img/icon/icon_4.png" alt="">
                        <h4>Free shipping</h4>
                        <p>Divided face for bearing the divide unto seed winged divided light Forth.</p>
                    </div>
                </div>
    ...
    <!-- swiper js -->
    <script src="/Wshop/local/public/winter/js/lightslider.min.js"></script>
    <!-- swiper js -->
