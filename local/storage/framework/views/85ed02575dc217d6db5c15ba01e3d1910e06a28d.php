    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right navbar-top-links">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i> <?php echo e(session()->get('Name')); ?> <b class="caret"></b>
                    </a>
...
<?php /**PATH C:\xampp\htdocs\wshop2\local\resources\views/startmin-master/master.blade.php ENDPATH**/ ?>